...
export default function Zsaklin1Wait() {
  const solution = SOLUTIONS.zsaklin[1]; // TODO: Lösung für Fragment 1
  ...
  return (
    <WaitRoom
      player="zsaklin"
      step={1}
      title="Fragment 1 gesichert"
      subtitle="Gib das Lösungswort ein. Wenn es stimmt, wartet kurz auf die anderen und tippt dann den Stern an."
      bgImgSrc={bgStars}
      starImgSrc={starImg}
      extra={
        <div
